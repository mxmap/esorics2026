...
from mail_municipalities.domain_resolver.countries.austria import (
...
class TestAustriaConfig:
    ...
    def test_domain_matches_name_prepositions(self):
        assert self.config.domain_matches_name("Neufeld an der Leitha", "neufeld-leitha.bgld.gv.at")
        assert self.config.domain_matches_name("Neuberg im Burgenland", "neuberg.bgld.gv.at")
        assert self.config.domain_matches_name("Oggau am Neusiedler See", "oggau-neusiedler-see.bgld.gv.at")
