...
from mail_municipalities.domain_resolver.countries.switzerland import (
...
class TestSwitzerlandConfig:
    ...
    def test_pick_best_email_name_match_before_regional(self):
        result = self.config.pick_best_email({"treyvaux.ch", "fr.ch"}, "Treyvaux", set(), region="Kanton Freiburg")
